            ...
            <div className="flex-1 overflow-y-auto space-y-12 pr-2 custom-scrollbar">
              ...
              <div className="pt-8 border-t border-slate-800/60">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Moteur de Ventes</p>
                ...
                <div className="space-y-3 bg-slate-950/40 p-4 rounded-2xl border border-slate-800/50 mb-4 shadow-inner">
                  ...
                  {formCampaign.type !== 'all' && (
                    <input 
                      placeholder={`Spécifier ${formCampaign.type}...`} 
                  ...
                  <div className="flex gap-2">
                    <input type="number" placeholder="%" value={formCampaign.value} className="w-16 bg-slate-800/50 border border-slate-700 p-2 rounded-lg text-[10px] text-center outline-none focus:border-blue-500" onChange={e => setFormCampaign({...formCampaign, value: e.target.value})} />
                    <button 
                      type="button"
